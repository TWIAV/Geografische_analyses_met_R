...
## Het aanmaken van een `SpatialPointsDataFrame` \label{spdf}
...
Het SpatialPointsDataFrame dat we in de vorige paragraaf (\ref{spdf}) hebben aangemaakt, is nog niet helemaal compleet, omdat we er nog geen coördinaatreferentiesysteem (CRS) aan hebben toegekend. Het Frame heeft weliswaar coördinaten, maar we hebben nog niet vastgelegd hoe deze aan de aarde te relateren zijn.
...
Het toekennen van een CRS gaat door middel van een `proj4string`, een lange ingewikkelde string met geodetische parameters. Gelukkig hebben veel projecties een zogeheten *EPSG* code, waardoor het makkelijker wordt om een `proj4string` toe te kennen.  
