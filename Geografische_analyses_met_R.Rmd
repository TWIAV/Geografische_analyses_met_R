...
header-includes:
   - \providecommand{\versionnumber}{0.3.6 - "New Morning"}
...
barplot(inw_prov$Inwoners/1000, names = inw_prov$Provincie_naam, las = 2,
        ylab = "Inwoners (* 1000)", space = 0, col = "lightblue",
        main = "Aantal inwoners per provincie - 1 januari 2014")
```
