...
header-includes:
   - \providecommand{\versionnumber}{0.3.8}
...
Tennekes is in 2013 begonnen met de ontwikkeling van deze package - de *Initial commit* in de [GitHub repository](https://github.com/mtennekes/tmap) dateert van 25 november 2013 - en op 28 mei 2015 is versie 1.0 van `tmap` vrijgegeven.

En in de zomer van 2015 heeft hij een [presentatie](http://user2015.math.aau.dk/presentations/20.pdf) gegeven, over `tmap`, op de [useR! Conference  2015](http://user2015.math.aau.dk/) in Aalborg, Denemarken.
