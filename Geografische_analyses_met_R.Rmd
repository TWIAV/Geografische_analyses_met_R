...
header-includes:
   - \providecommand{\versionnumber}{0.4.0 - "Geobuzz"}
...
\end{itemize}
Kortom: het welgemeende advies is om dit boek te lezen met een PDF reader op je favoriete \textit{device}. En op het moment dat je echt aan de slag gaat: gewwon op de computer waarop je ook \textbf{R} en \textbf{RStudio} hebt draaien.\par
